    ...
    <div class="container px-5 py-24 mx-auto" >
        ...
        <?php
                ...
                ?>
                    ...
                    <td><a href="update.php?edit=<?php echo $row['id']; ?>" ><button name='update' type="button" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-1 px-4 border border-blue-500 hover:border-transparent rounded">
                    Update</button></a></td>


                    <td><a href="delete_update.php?del=<?php echo $row['id']?>" name ='remove' ><button type="button" class="bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-white py-1 px-4 border border-blue-500 hover:border-transparent rounded">
                    Delete</button></a></td>
